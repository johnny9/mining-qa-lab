...
| `lab-orchestrator` | Central coordination agent | supported | [SPEC.md](lab-orchestrator/central-coordination-agent/SPEC.md) | Pull portable Status work, bind it privately, execute through immutable attempts, and complete it safely. |
