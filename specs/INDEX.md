...
| `lab-orchestrator` | Central coordination agent | proposed | [SPEC.md](lab-orchestrator/central-coordination-agent/SPEC.md) | Pull portable Status work, bind it privately, execute through immutable attempts, and complete it safely. |
